...
.pauseFor(1800)
.changeDelay(20)
.typeString('Bonjour, moi c\'est Marie Tardivel')
.pauseFor(300)
...
const allBarres = document.querySelectorAll('.barres-skill')
const allShadowBarres = document.querySelectorAll('.barres-grises')
